...
def home(request):
	import json
	import requests
	api_request=requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=75189&distance=2&API_KEY=5FE6B2A4-9F32-4E05-8BF8-770391998EC3");
	#http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=75189&distance=2&API_KEY=5FE6B2A4-9F32-4E05-8BF8-770391998EC3
	try:
